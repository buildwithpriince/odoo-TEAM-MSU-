    ...
    <div className="space-y-8 animate-in fade-in duration-200">
      ...
      <div className="editorial-card p-6 sm:p-10 space-y-6">
        <div className="max-w-2xl">
          ...
          <p className="text-sm text-[#6B5E55] mt-2 leading-relaxed">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-3 pt-2">
          <div className="md:col-span-6 relative">
            ...
            <input
              type="text"
              placeholder="Search by city, country, or keyword (e.g. Shimla, Jaipur, Alps)..."
              value={searchQuery}
              onChange={(e) => setSearchQuery(e.target.value)}
              className="w-full pl-10 pr-4 py-3 bg-[#FAF7F2] border border-[#E0D7C8] rounded-xl text-xs sm:text-sm text-[#2C221E] placeholder-[#8F8175] focus:outline-hidden focus:ring-2 focus:ring-[#964223]/30"
            />
          </div>
          ...
          <div className="md:col-span-3">
            <select
              ...
              className="w-full px-3.5 py-3 bg-[#FAF7F2] border border-[#E0D7C8] rounded-xl text-xs sm:text-sm text-[#2C221E] focus:outline-hidden focus:ring-2 focus:ring-[#964223]/30"
            >
          ...
          <div className="md:col-span-3">
            ...
            >
              ...
              <option value="$">$ Budget Friendly (&lt;$70/d)</option>
              <option value="$$">$$ Moderate ($70-$120/d)</option>
              <option value="$$$">$$$ Premium ($120-$200/d)</option>
              <option value="$$$$">$$$$ Luxury ($200+/d)</option>
            </select>
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {filteredDestinations.map((dest) => (
          <div
            ...
            className="editorial-card-hover group flex flex-col justify-between overflow-hidden cursor-pointer"
          ...
          >
            <div>
              ...
              <div className="relative h-52 w-full overflow-hidden bg-[#1E140F]">
                ...
                <div className="absolute top-3 left-3 right-3 flex items-center justify-between">
                  <span className="px-2.5 py-1 rounded-lg bg-black/50 backdrop-blur-md text-white text-[10px] font-bold uppercase tracking-wider border border-white/20">
                    {dest.vibe}
                  </span>
                  <span className="px-2.5 py-1 rounded-lg bg-black/50 backdrop-blur-md text-emerald-300 text-[11px] font-bold border border-white/20">
                    ${dest.averageDailyCost}/day
                  </span>
                </div>

                <div className="absolute bottom-3 left-3 right-3 text-white">
                  <h3 className="font-serif-heading text-2xl font-bold leading-none drop-shadow-xs">
                    {dest.name}
                  </h3>
              ...
              <div className="p-5 space-y-3">
                ...
                <div className="flex flex-wrap gap-1.5 pt-1">
                  {dest.highlights.slice(0, 3).map((hl, i) => (
                    <span 
                      key={i}
                      className="text-[10px] font-medium text-[#6B5E55] bg-[#F0EAE1] px-2 py-0.5 rounded-md"
                    >
                      {hl}
                    </span>
                  ))}
            ...
            <div className="p-5 pt-0 flex items-center justify-between border-t border-[#EAE2D5] mt-2 pt-3">
              <span className="text-[11px] text-[#8F8175]">
                Best: <span className="font-semibold text-[#2C221E]">{dest.popularSeason.split(' ')[0]}</span>
              </span>
              ...
              <Link
                ...
                className="px-3.5 py-1.5 rounded-xl bg-[#964223] text-white text-xs font-bold hover:bg-[#7D351B] transition-colors inline-flex items-center gap-1"
              >
                <span>Plan Trip</span>
